...
import { ContinueLearningButton } from "@/components/layout/continue-learning";
  ...
  return (
    <div className="flex flex-col gap-20 pb-16">
      ...
      <section className="flex flex-col items-center px-2 pt-8 text-center sm:pt-20">
        ...
        <div className="mt-8">
          <ContinueLearningButton label={t("start")} />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-2xl overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950">
          ...
          <pre className="overflow-x-auto p-4 text-sm leading-relaxed">
            <code>
              ...
              <span className="text-zinc-300"> (response.stopReason !== </span>
              ...
              <span className="text-zinc-300"> (</span>
              <span className="text-purple-400">const</span>
              <span className="text-zinc-300"> toolCall of response.toolCalls) {"{"}</span>
              {"\n"}
              <span className="text-purple-400">{"    "}const</span>
              <span className="text-zinc-300"> result = </span>
              <span className="text-purple-400">await</span>
              <span className="text-zinc-300"> tools[toolCall.name](toolCall.input)</span>
              {"\n"}
