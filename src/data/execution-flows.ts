...
export const EXECUTION_FLOWS: Record<string, FlowDefinition> = {
  ...
  s13: {
    nodes: [
      ...
      { id: "llm", label: "LLM Call", type: "process", x: COL_CENTER, y: 110 },
      { id: "tool_check", label: "tool_use?", type: "decision", x: COL_CENTER, y: 190 },
      { id: "bg_decision", label: "Slow work?", type: "decision", x: COL_LEFT, y: 280 },
      { id: "start_bg", label: "Start Background Task", type: "subprocess", x: 70, y: 370 },
      { id: "placeholder", label: "Return Task ID", type: "process", x: 70, y: 450 },
      { id: "foreground", label: "Execute Immediately", type: "subprocess", x: COL_LEFT + 90, y: 370 },
      { id: "notify", label: "Completion Notification", type: "process", x: 70, y: 530 },
      { id: "append", label: "Append Result", type: "process", x: COL_CENTER, y: 530 },
      { id: "end", label: "Output", type: "end", x: COL_RIGHT, y: 280 },
    ],
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "bg_decision", label: "yes" },
      { from: "tool_check", to: "end", label: "no" },
      { from: "bg_decision", to: "start_bg", label: "background" },
      { from: "bg_decision", to: "foreground", label: "foreground" },
      { from: "start_bg", to: "placeholder" },
      { from: "placeholder", to: "llm" },
      { from: "start_bg", to: "notify", label: "later" },
      { from: "notify", to: "append" },
      { from: "foreground", to: "append" },
      { from: "append", to: "llm" },
    ],
  },
  s14: {
    nodes: [
      { id: "start", label: "User Input", type: "start", x: COL_CENTER, y: 30 },
      { id: "llm", label: "LLM Call", type: "process", x: COL_CENTER, y: 110 },
      { id: "tool_check", label: "create schedule?", type: "decision", x: COL_CENTER, y: 190 },
      { id: "schedule_tool", label: "Schedule Tool", type: "subprocess", x: COL_LEFT, y: 280 },
      { id: "durable_store", label: "Durable Job Store", type: "process", x: COL_LEFT, y: 370 },
      { id: "scheduler_loop", label: "Scheduler Tick", type: "process", x: COL_RIGHT, y: 370 },
      { id: "cron_match", label: "Cron Matches?", type: "decision", x: COL_RIGHT, y: 460 },
      { id: "queue", label: "Queue Prompt", type: "process", x: COL_RIGHT, y: 540 },
      { id: "agent_loop", label: "Fresh Agent Run", type: "subprocess", x: COL_CENTER, y: 620 },
      { id: "append", label: "Append Outcome", type: "process", x: COL_LEFT, y: 540 },
      { id: "end", label: "Output", type: "end", x: COL_RIGHT, y: 280 },
    ],
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "schedule_tool", label: "yes" },
      { from: "tool_check", to: "end", label: "no" },
      { from: "schedule_tool", to: "durable_store" },
      { from: "durable_store", to: "append", label: "created" },
      { from: "durable_store", to: "scheduler_loop", label: "stored job" },
      { from: "scheduler_loop", to: "cron_match" },
      { from: "cron_match", to: "queue", label: "yes" },
      { from: "cron_match", to: "scheduler_loop", label: "no" },
      { from: "queue", to: "agent_loop" },
      { from: "agent_loop", to: "append" },
      { from: "append", to: "llm" },
    ],
  },
  s15: {
